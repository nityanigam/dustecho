...
filenames = ["nH5.0e-01_lam1.14um_theobs0.35_Ldnu_xcentr.txt",
             "nH5.0e-01_lam1.39um_theobs0.35_Ldnu_xcentr.txt",
             "nH5.0e-01_lam1.54um_theobs0.35_Ldnu_xcentr.txt"]
...
for i in range(len(filenames)):
    ...
    ax.plot(tobs, Ldnu_cgs, color=colors[i], label="$\\lambda = $"+str(lam))
